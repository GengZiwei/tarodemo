...
class Wechat {
  ...
  static removeStorage(key) {
    return new Promise((resolve, reject) => {wx.removeStorage({ key: key, success: resolve, fail: reject })})
  }
  ...
  static getNetworkType(type) {
    return new Promise((resolve, reject) => wx.getNetworkType({ type: type, success: resolve, fail: reject }));
  };
