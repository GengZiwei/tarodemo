...
class App extends Component {
  ...
  config = {
    "pages": [
      "pages/index/index",
      "pages/navigation_ride/index",
      "pages/inputTip/inputtip",
      "pages/login/login",
      "pages/readyCommit/index",
      "pages/center/center",
      "pages/more/more",
      "pages/orderlist/orderlist",
      "pages/response/index",
      "pages/waitresponse/index",
      "pages/range/index",
      "pages/address/address",
      "pages/inputAddress/inputAddress",
      "order/order-payment/index",
      "order/order_pending/index",
      "order/order_progress/index"
    ],
    "subpackages": [
      {
        "root": "wallet",
